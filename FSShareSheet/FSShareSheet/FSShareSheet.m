...
#define kFSShareSheetHeight (kFSShareCellHeight*2+kFSShareSheetBtnH+kFSShareSheetTitleH)
...
- (UILabel *)headerView
{
    UILabel *headerLabel        = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, screenWidth, kFSShareSheetTitleH)];
